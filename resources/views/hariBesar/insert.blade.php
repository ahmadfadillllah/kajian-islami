            ...
            <div class="col-xl-12">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <h3>Tambah Data Hari Besar</h3>
                  </div>
                  <div class="card-body custom-input">
                    <form action="{{ route('haribesar.post') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="namaHariBesar" type="text" name="nama" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="durasiHariBesar" type="text" name="durasi" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="hargaContainer" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="hargaHariBesar" type="text" name="harga">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
