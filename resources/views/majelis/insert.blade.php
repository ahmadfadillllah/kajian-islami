            ...
            <div class="col-xl-12">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <h3>Tambah Data Majelis</h3>
                  </div>
                  <div class="card-body custom-input">
                    <form action="{{ route('majelis.post') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="namaMajelis" type="text" name="nama" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="jenisMajelis" type="text" name="jenis" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="kegiatanMajelis">Kegiatan Majelis</label>
                                    <input class="form-control" id="kegiatanMajelis" type="text" name="kegiatan" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="streamingKultum" type="text" name="streaming" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6" id="hargaContainer" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="hargaMajelis" type="text" name="harga">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
