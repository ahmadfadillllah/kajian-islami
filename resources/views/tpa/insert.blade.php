            ...
            <div class="col-xl-12">
                <div class="card">
                  <div class="card-header card-no-border pb-0">
                    <h3>Tambah Data TPA</h3>
                  </div>
                  <div class="card-body custom-input">
                    <form action="{{ route('tpa.post') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="namaTPA" type="text" name="nama" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="durasiTPA" type="text" name="durasi" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6" id="hargaContainer" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="hargaTPA" type="text" name="harga">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="streamingTPA">Link Streaming</label>
                                    <input class="form-control" id="streamingTPA" type="text" name="streaming" >
                                </div>
                            </div>
                        </div>
