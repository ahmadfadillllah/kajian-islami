                ...
                <div class="login-card login-dark">
                    ...
                    <div>
                        ...
                        <div class="login-main">
                            <form action="{{ route('register.post') }}" method="POST" class="theme-form">
                                @csrf
                                <h2 class="text-center">Form Registrasi</h2>
                                <div class="form-group">
                                    <label class="col-form-label">Username</label>
                                    <input class="form-control" type="text" required="" name="username" placeholder="Masukkan Username" required>
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Nama Lengkap</label>
                                    <input class="form-control" type="text" required="" name="name" placeholder="Masukkan Nama Lengkap" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mb-0 checkbox-checked">
                                    <div class="form-check checkbox-solid-info">
                                        <input class="form-check-input" id="solid6" type="checkbox" checked disabled>
                                        <label class="form-check-label" for="solid6">Saya menyetujui syarat dan ketentuan yang berlaku!</label>
                                    </div>
                                    <div class="text-end mt-3">
                                        <button class="btn btn-primary btn-block w-100" type="submit">Daftar </button>
                                    </div>
                                </div>
                                <p class="mt-4 mb-0 text-center">Sudah punya akun?<a class="ms-2" href="{{ route('login') }}">Login disini!</a></p>
                                <hr>
